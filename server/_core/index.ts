  ...
  app.use(helmet({
    contentSecurityPolicy: {
      directives: {
        ...
        // Stripe checkout frames; blob: for PDFs the app fetches server-side
        // and renders from memory (close-flow roadmap); the document hosts
        // cover any iframe still pointing at stored URLs (portal roadmap).
        frameSrc: ["https://js.stripe.com", "https://hooks.stripe.com", "blob:", "https://res.cloudinary.com", "https://d2xsxph8kpxj0f.cloudfront.net"],
      ...
      case "payment_intent.succeeded": {
        ...
        try {
          ...
          if (inv) {
            ...
            // One receipt + (for deposits) job + scheduling task, idempotent
            // on receiptSentAt so PI/Checkout double-fires can't duplicate.
            try {
              ...
              console.error('[Webhook] PI invoice completion failed:', completionErr);
            }
          } else {
          ...
          if (inv) {
            ...
            try {
              ...
              await onInvoicePaid({
                ...
                method: "card",
                reference: (session.payment_intent as string | undefined) ?? session.id,
              });
            } catch (completionErr) {
              console.error('[Webhook] Checkout invoice completion failed:', completionErr);
            }
          } else {
    ...
    try {
      ...
      const html = `<!DOCTYPE html><html><head><meta charset="utf-8"/><style>
        ...
        <div class="header-bar">
          ...
          <div><div class="company">Handy Pioneers</div><div class="tagline">808 SE Chkalov Dr 3-433, Vancouver, WA 98683 &nbsp;|&nbsp; (360) 838-6731 &nbsp;|&nbsp; help@handypioneers.com</div></div>
        ...
        <div class="body">
          ...
          <div class="footer">Handy Pioneers &nbsp;·&nbsp; 808 SE Chkalov Dr 3-433, Vancouver, WA 98683 &nbsp;·&nbsp; (360) 838-6731 &nbsp;·&nbsp; help@handypioneers.com</div>
        </div>
      </body></html>`;
