-- 0071_oauth_integrations.sql
-- Creates tables for Google Business Profile, Meta, and Google Ads OAuth connections.
-- Uses IF NOT EXISTS so boot-time CREATE TABLE in ensureOAuthIntegrationTables() is idempotent.
