  ...
  if (existing && !prefilled) {
    ...
    for (const sys of existing) {
      ...
      updated[key] = {
        ...
        lastServiceDate: sys.lastServiceDate ? new Date(sys.lastServiceDate).toISOString().split("T")[0] : '',
        nextServiceDate: sys.nextServiceDate ? new Date(sys.nextServiceDate).toISOString().split("T")[0] : '',
