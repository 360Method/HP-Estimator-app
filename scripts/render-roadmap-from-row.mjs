 ...
 *
 * Usage:
 *   railway run -s HP-Estimator-app -- pnpm tsx scripts/render-roadmap-from-row.mjs <translationId> <outPath>
 */
...
if (!id || !outPath) {
  console.error("usage: tsx scripts/render-roadmap-from-row.mjs <translationId> <outPath>");
  process.exit(1);
}
